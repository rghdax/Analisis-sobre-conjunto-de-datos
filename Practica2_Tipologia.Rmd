...
```{r supuesto de normalidad de variables drama.movies, warning=FALSE}
...
```{r supuesto de normalidad de variables horror.movies, warning=FALSE}
...
```{r aplicando el t.test hipotesis2}
...
\hline
  ...
  Investigación previa  & D.B.M, R.G.H \\ \hline
  Redacción de respuestas & D.B.M, R.G.H \\ \hline
  Desarrollo de código & D.B.M, R.G.H \\ \hline
\end{tabular} 
